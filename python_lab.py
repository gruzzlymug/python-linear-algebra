...
S = {-4, -2, 1, 2, 5, 0}
# Replace [ ... ] with a one-line list comprehension in which S appears
exclude_zero_list = [(x,y,z) for x in S for y in S for z in S if (x+y+z) == 0 and not x==y==z==0]
...
first_of_tuples_list =  [(x,y,z) for x in S for y in S for z in S if (x+y+z) == 0 and not x==y==z==0][0]
...
odd_num_list_range = {x for x in range(100)[1::2]}
...
# Complete the procedure definition by replacing [ ... ] with a one-line list comprehension
def cubes(L): return [n*n*n for n in L]
